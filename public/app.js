...
const BEATS_CATALOG = [
  {
    ...
    key: "C Minor",
    price: 2500,
    artwork: "/images/golden-dreams.jpg",
    previewAudio: "/audio/golden-dreams-preview.mp3",
    description: "High-energy trap beat with dark, moody vibes. Perfect for rap and hip-hop production.",
    available: true,
    featured: true
  },
  {
    ...
    key: "Bb Major",
    price: 3000,
    artwork: "/images/night-vibes.jpg",
    previewAudio: "/audio/night-vibes-preview.mp3",
    description: "Smooth R&B instrumental with soulful melodies and warm production.",
    available: true,
    featured: false
  },
  {
    ...
    key: "G Major",
    price: 2800,
    artwork: "/images/afro-groove.jpg",
    previewAudio: "/audio/afro-groove-preview.mp3",
    description: "Authentic Afrobeat production with rich percussion and infectious grooves.",
    available: true,
    featured: true
  },
  {
    ...
    key: "F# Minor",
    price: 3200,
    artwork: "/images/urban-heat.jpg",
    previewAudio: "/audio/urban-heat-preview.mp3",
    description: "Classic hip-hop beat with boom-bap drums and tight production.",
    available: true,
    featured: false
  },
  {
    ...
    key: "D Minor",
    price: 2900,
    artwork: "/images/midnight-energy.jpg",
    previewAudio: "/audio/midnight-energy-preview.mp3",
    description: "Fast-paced trap beat with aggressive energy and modern sound design.",
    available: true,
    featured: true
  },
  {
    ...
    key: "Eb Major",
    price: 3500,
    artwork: "/images/soulful-journey.jpg",
    previewAudio: "/audio/soulful-journey-preview.mp3",
    description: "Emotional R&B instrumental with lush strings and deep bass.",
    available: true,
    featured: false
  }
];
